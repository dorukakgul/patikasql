...
--4.
select first_name,last_name from customer where first_name like 'Mary';

--5.
select length,rental_rate from film where not length >50 and rental_rate = 0.99  order by length;
